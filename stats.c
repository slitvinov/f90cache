...
static struct {
    ...
    { STATS_ERROR,        "f90cache internal error        ", NULL, 0 },
    ...
    { STATS_NOTF,         "not a Fortran file             ", NULL, 0 },
...
static void stats_update_size(enum stats stat, size_t size)
{
    ...
    if (getenv("F90CACHE_NOSTATS")) return;
